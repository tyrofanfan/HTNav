...
GOAL_PREDICTOR_CHECKPOINT_DIR = PROJECT_ROOT/"checkpoints/goal_predictorprogress_098goalchange_a080"
BASELINE_WITH_MAP_CHECKPOINT_DIR = PROJECT_ROOT/"checkpoints/baseline_with_map"

CITYREFER_DATA_DIR = PROJECT_ROOT/"data/newcityrefer"
OBJECTS_PATH = CITYREFER_DATA_DIR/"objects.json"
PROCESSED_DECRIPTIONS_PATH = CITYREFER_DATA_DIR/"processed_descriptions.json"
MTURK_TRAJECTORY_DIR = PROJECT_ROOT/"data/newcitynav"
